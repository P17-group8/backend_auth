"""
Django settings for operator_ms project.
...
SECRET_KEY = 'django-insecure-pr-yb9hx=410$_nwzji@j-+&eish$wdtq3sarl(7c59$1^1r(g'
...
WSGI_APPLICATION = 'operator_ms.wsgi.application'
